...
const Footer = () => {
  ...
  useEffect(() => {
    if (isMobile && (isCompanyOpen || isInfoOpen || isContactOpen)) {
      document.body.classList.add('active-modal');
    } else {
      document.body.classList.remove('active-modal');
    }
  }, [isMobile, isCompanyOpen, isInfoOpen, isContactOpen]);

  return (
    <footer className={isMobile ? style.mobileFooter : style.desktopFooter}>
      <div className={style.main}>
        <div className={style.upper}>
          <div className={style.upperInfo}>
            <div style={{ marginRight: '7.85vw' }} className={style.footerSections}>
              <p className={style.footerTitle} onClick={isMobile ? toggleCompany : undefined}>
                Company
              </p>
              {((isMobile && isCompanyOpen) || !isMobile) && (
                <>
                  <p>about us</p>
                  <p>blog</p>
                  <p>returns</p>
            ...
            <div style={{ marginRight: '7.153vw' }} className={style.footerSections}>
              <p className={style.footerTitle} onClick={isMobile ? toggleInfo : undefined}>
                Info
              </p>
              {((isMobile && isInfoOpen)||!isMobile) && (
                <>
                  <p>How it works?</p>
                  <p>our promises</p>
                  <p>FAQ</p>
            ...
            <div style={{ marginRight: '9.72vw' }} className={style.footerSections}>
              <p className={style.footerTitle} onClick={isMobile ? toggleContact : undefined}>
                Contact us
              </p>
              {((isMobile && isContactOpen)||!isMobile) && (
                <>
